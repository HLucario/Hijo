...
import com.example.hijo.models.Hijo
import com.example.hijo.models.HijoResponse
import okhttp3.ResponseBody
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import com.example.hijo.api.HijoNetwork
import com.example.hijo.api.asNetwork
...
class Seleccion : AppCompatActivity()
{
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        RetrofitClient.instance.listarHijos(email.toString()).enqueue(object : Callback<List<HijoResponse>>
        {
            override fun onResponse(call: Call<List<HijoResponse>>, response: Response<List<HijoResponse>>)
            {
                if (response.code() == 200)
                {
                    ...
                    val adaptador = ArrayAdapter(applicationContext, android.R.layout.simple_list_item_1,list)
